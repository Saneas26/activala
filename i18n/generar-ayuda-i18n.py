#!/usr/bin/env python3
# Genera js/ayuda-i18n.js desde i18n/legal-fuente-es.json + legal-{de,en,no,sv}.json.
...
#   python3 i18n/generar-ayuda-i18n.py
...
dics = {}
for lang in IDIOMAS:
    nombre = 'ayuda-fuente-es.json' if lang == 'es' else f'ayuda-{lang}.json'
...
CABECERA = """/* Motor i18n de las página de ayuda (/ayuda).
...
(RAIZ / 'js' / 'ayuda-i18n.js').write_text(salida, encoding='utf-8')
print(f'OK js/ayuda-i18n.js generado: {len(claves_es)} claves x {len(IDIOMAS)} idiomas, {len(salida)} bytes')
